            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 dark:from-gray-900 dark:via-gray-800 dark:to-black rounded-3xl p-12 text-white">
                ...
                <p className="text-blue-100 dark:text-gray-300 text-lg mb-8">
                  Create an account to access thousands of products from verified vendors worldwide.
                </p>
                
                <div className="space-y-4">
                  {[
                    { icon: CheckCircle, text: "Shop from 10,000+ verified vendors" },
                    { icon: CheckCircle, text: "Secure payment & buyer protection" },
                    { icon: CheckCircle, text: "Fast shipping & easy returns" },
                    { icon: CheckCircle, text: "Exclusive deals & discounts" }
                  ].map((item, idx) => (
